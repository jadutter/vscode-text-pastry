...
import type { GetNextRangeEntryFnc, GetRangeFnc, RangeResult } from './main';
...
export const handleRange = (rangeMethod: RangeResult | GetRangeFnc) => {
    ...
    editor.edit((editBuilder) => {
        ...
        cursors.forEach((selection, index) => {
            const range = new Position(selection.start.line, selection.start.character);
